...
function ResourceButton(props) {
  return (
    <Button
      ...
      style={{ textAlign: "left", width: "80%", margin: "5px 10%" }}
      href={props.link}
      target="_blank"
      ...
      <div style={{ width: "100%" }}>
        <div style={{ float: "left" }}>
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>General Resources</h3>
          ...
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>News and Events</h3>
        ...
        <div style={{ float: "left" }}>
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>Online Resources</h3>
          ...
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>Involvement</h3>
        ...
        <div style={{ float: "left" }}>
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>Help and Safety</h3>
          ...
          <Panel shaded bordered className="panel" style={{ width: "350px" }}>
            <h3 style={{ margin: "0px 10%" }}>Other</h3>
